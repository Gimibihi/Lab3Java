...
public class Kompiuteris implements KTUable<Kompiuteris> {
     ...
     */
    public Kompiuteris(){ID = String.valueOf((raktas++));}
    ...
    public String toString() {
        return  getID() + "= Kompiuteris_" + procesoriausGamintojas + ":" + procesoriausModelis + " " + ramuKiekis + "GB " + kietojoDiskoVieta + "GB " + nasumas + " " +String.format("%7.2f", kaina) + "\u20AC";
    }
